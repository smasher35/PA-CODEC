...
const char *gengetopt_args_info_help[] = {
  ...
  "      --decode=.cod file        Decodes a Z2/Z5 file",
  "      --decode-dir=folder to process\n                                Decodes recursivally all Z2/Z5 files in a\n                                  folder",
  "      --encode=.pgm file        Encodes a P2/P5 file",
  "      --parallel-encode=.pgm file\n                                Encodes a P2/P5 file using threads",
  "      --PSNR=original file,decoded file\n                                Computes the peak signal-to-noise ratio between\n                                  two images",
  "  -a, --about                   Author info",
  "      --dict=.dic file          Dictionary use to encode/decode files",
  "      --threads=INT             Number of threads to use on the parallel\n                                  version",
    0
};
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->decode_help = gengetopt_args_info_help[3] ;
  args_info->decode_dir_help = gengetopt_args_info_help[4] ;
  args_info->encode_help = gengetopt_args_info_help[5] ;
  args_info->parallel_encode_help = gengetopt_args_info_help[6] ;
  args_info->PSNR_help = gengetopt_args_info_help[7] ;
  args_info->PSNR_min = 2;
  args_info->PSNR_max = 2;
  args_info->about_help = gengetopt_args_info_help[8] ;

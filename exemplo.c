...
const char *gengetopt_args_info_purpose = "Exemplificar gengetopt";

const char *gengetopt_args_info_usage = "Usage: gengetopt_basico [OPTIONS]...";

const char *gengetopt_args_info_versiontext = "";

const char *gengetopt_args_info_description = "Exemplo básico do gengetopt";
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVaf:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'a':	/* opção -a / -all.  */
          ...
          break;
        case 'f':	/* requer nome de ficheiro.  */
